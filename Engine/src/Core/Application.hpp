...
namespace SW {
    ...
    public:
		 ...
		 * 
		 * This function is called when the application starts. It should be used to perform any necessary initialization.
		 * 
		 ...
		 * 
		 * This function is called when the application is about to close. It should be used to perform any necessary cleanup.
		 * 
