...
namespace SW
{
	...
	struct IDComponent
	{
		...
		IDComponent() : ID(Random::CreateID()) {}
		IDComponent(u64 id) : ID(id) {}
	};
	 ...
	 * @brief This component is used to store the color of an entity. This component is used for rendering of squares
	 * and rectangles.
	 */
	struct SpriteComponent
	{
	 ...
	 * @brief This component is used to store the color of an entity. This component is used for rendering of circles
	 * and rings.
	 */
	struct CircleComponent
	{
	...
	struct RelationshipComponent
	{
		...
		RelationshipComponent(u64 parentID) : ParentID(parentID) {}
	};
	...
	struct RigidBody2DComponent
	{
		...
		f32 RestitutionThreshold =
		    0.5f; /**< Restitution velocity threshold, usually in [m/s] (above this speed will bounce). */
		...
		bool IsBullet = false; /**< Is this a fast moving body that should be prevented from tunneling through other
		                          moving bodies? */
	};
	...
	struct PolygonCollider2DComponent
	{
		...
		std::vector<glm::vec2> Vertices = {
		    {0.0f, 0.0f}, {1.0, 0.0f}, {0.0f, 1.0f}}; /**< Vertices of the polygon collider */
