...
namespace SW::GUI
{
	...
	void Appearance::ApplyColors(const Colors& colors)
	{
		...
		// gizmo imguizmoStyle->RotationLineThickness = 3.f;			// Thickness of lines for rotation gizmo
		...
		// imguizmoStyle->CenterCircleSize = 4.f;				// Size of circle at the center of the translate/scale
		// gizmo
	}
